...
PARAMETROS
    :PARAMETROS ',' OPCION_PARAMETROS   {$$ = $1; $$.push(new Declaracion($3, [$4], null,@1.first_line, @1.first_column));
    ...
    |OPCION_PARAMETROS               {$$ = []; $$.push(new Declaracion($1, [$2], null,@1.first_line, @1.first_column));
